...
<body>
	<div class="container mt-5">
		...
		<ul class="social-icons justify-content: space-around; ">
			...
			<a href="https://www.facebook.com/ducatEducation"><li
				style="padding-left: 20px;"><i class="bi bi-facebook"></i></li></a>
			<li style="padding-left: 20px;"><i class="bi bi-instagram"></i></li>
			<li style="padding-left: 20px;"><i class="bi bi-linkedin"></i></li>
			<div class="p">
				<a
					href="https://api.whatsapp.com/send/?phone=%2B919999993213&text&type=phone_number&app_absent=0">
